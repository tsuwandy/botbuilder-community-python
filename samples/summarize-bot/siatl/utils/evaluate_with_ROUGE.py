...
def eval_rouge(dec_pattern, dec_dir, ref_pattern, ref_dir, dir_name,
    ...
    tmp_dir = '/mnt/e/Work/Summarization_samples/siatl_summarization/output/{}/temp/'.format(dir_name)
...
def main():
    ...
    dec_dir = '/mnt/e/Work/Summarization_samples/siatl_summarization/output/{}/dec/'.format(dir_name)
    ref_dir = '/mnt/e/Work/Summarization_samples/siatl_summarization/output/{}/ref/'.format(dir_name)

    if not os.path.exists('/mnt/e/Work/Summarization_samples/siatl_summarization/output/{}/dec/'.format(dir_name)):
        exit()
