...
class SumClfTrainer(Trainer):
    ...
    def process_batch(self, inputs, posts, labels, lengths, posts_lengths):
        lm_logits, cls_logits, attentions = self.model(inputs, lengths, posts, posts_lengths)
